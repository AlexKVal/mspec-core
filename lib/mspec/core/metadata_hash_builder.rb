    ...
    module MetadataHashBuilder
      module Common
        def build_metadata_hash_from(args)
          ...
          if MSpec.configuration.treat_symbols_as_metadata_keys_with_true_values?
...
In MSpec 3, these symbols will be treated as metadata keys with
