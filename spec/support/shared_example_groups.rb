shared_examples_for "metadata hash builder" do
  ...
  context "when MSpec.configuration.treat_symbols_as_metadata_keys_with_true_values is set to false" do
    ...
    it 'prints a deprecation warning about any symbols given as arguments' do
      warning_receiver.should_receive(:warn).with(/In MSpec 3, these symbols will be treated as metadata keys/)
